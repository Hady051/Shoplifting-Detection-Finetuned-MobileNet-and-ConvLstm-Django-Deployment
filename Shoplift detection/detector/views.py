...
## Hyper parameters (old model version 3)
# NUM_FRAMES = 40
# IMG_HEIGHT = 64
# IMG_WIDTH = 64
# CHANNELS = 3

## Hyper parameters (new model version 4)
NUM_FRAMES = 45
IMG_HEIGHT = 72
IMG_WIDTH = 72
CHANNELS = 3
...
def build_cnn_convlstm_model(input_shape=(NUM_FRAMES, IMG_HEIGHT, IMG_WIDTH, CHANNELS),
                             num_classes=2, trainable_layers=30):
